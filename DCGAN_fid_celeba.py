...
file_path = "{}_out_{}_{}.txt".format(prefix, dataset,ngf)
error_path = "{}_err_{}_{}.txt".format(prefix, dataset,ngf) # <-comment out to see the output
tmp = sys.stdout
...
if __name__ ==  '__main__':
    ...
    if dataset == 'CelebA':
        if mode =="whitebox":
            ...
            net_attacker = Generator_MLP(nc, nz, ngf).to(device)
    elif dataset == 'CIFAR':
            ...
            for i, participant_set in enumerate(participants_train_set):
                ...
                if i == 0:
                    ...
                    for attacker_round in range(5):
                        ...
                        print("fake attacker shape: ", fake_attacker.shape)
